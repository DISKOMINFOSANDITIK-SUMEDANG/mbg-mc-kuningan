...
export default function CreateOfftakerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setError(data.error || 'Gagal membuat offtaker');
        return;
      }

      alert('Offtaker berhasil dibuat');
      router.push('/cms/offtakers');
    } catch (err) {
      console.error('Error creating offtaker:', err);
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg p-6 text-white">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold">Tambah Offtaker Baru</h1>
                  <p className="text-purple-100">Daftarkan offtaker baru untuk mengelola produk</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="p-6 flex justify-end space-x-3">
              ...
              >
                ...
                {loading ? 'Menyimpan...' : 'Simpan Offtaker'}
              </button>
            </div>
          </form>
        </div>
