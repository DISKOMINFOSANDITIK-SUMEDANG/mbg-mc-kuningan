        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Kelola produk komoditas yang Anda sediakan</p>
            </div>
            <button
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-600">Mulai dengan menambahkan produk komoditas yang Anda sediakan.</p>
              </div>
            ) : (
                      ...
                      <tr key={product.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-600">
                            {product.minimum_order} {product.commodities?.unit || '-'}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setForm({ ...form, minimum_order: parseFloat(e.target.value) || 1 })}
                            min="0.1"
                            step="0.1"
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
