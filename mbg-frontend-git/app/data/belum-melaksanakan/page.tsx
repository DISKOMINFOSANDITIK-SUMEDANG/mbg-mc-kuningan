...
export default function BelumMelaksanakanPage() {
    ...
    const loadSchoolData = async () => {
      try {
        ...
        const summaryResponse = await fetch(
          "/data/Visualisasi MBG_Belum Melaksanakan_Tabel.csv"
        );
        ...
        const detailResponse = await fetch(
          "/data/Visualisasi MBG_Belum Melaksanakan_Tabel(1).csv"
        );
        ...
        const schoolDetails: SchoolDetail[] = detailLines
          ...
          .map((line, index) => {
            ...
            return {
              ...
              tikor: tikorStr,
              sasaranSiswa: parseInt(values[4]?.trim() || "0") || 0,
              latitude,
              longitude,
            };
          });
  ...
  const totalStats = summaryData.reduce(
    ...
    if (loading) {
    return <DataPageSkeleton heroTitle="Belum Melaksanakan" statCount={2} />;
  }

  return (
    <AppLayout className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-orange-50 via-white to-red-50/30 py-20 sm:py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center animate-fade-in">
            <div className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full text-sm font-semibold mb-6 shadow-lg shadow-orange-500/30">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 mb-6 leading-tight tracking-tight">
              Sekolah yang Belum
              <span className="block bg-gradient-to-r from-orange-600 via-orange-700 to-red-600 bg-clip-text text-transparent mt-2">
                Melaksanakan
              </span>
            </h1>
      ...
      {/* Stats Overview */}
      <section className="py-20 sm:py-24 bg-gradient-to-br from-white via-orange-50/30 to-red-50/20 relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-72 h-72 bg-orange-100/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-72 h-72 bg-red-100/30 rounded-full blur-3xl"></div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full text-xs font-semibold mb-5 shadow-lg shadow-orange-500/30">
            ...
            <div className="group relative bg-gradient-to-br from-orange-600 via-orange-600 to-orange-700 rounded-3xl shadow-xl p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center">
                  ...
                  <div className="text-white/80 text-sm font-medium mb-1">Sekolah Belum Melaksanakan</div>
                  <div className="text-white/60 text-xs">Dalam proses persiapan</div>
                </div>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-blue-600 via-blue-600 to-blue-700 rounded-3xl shadow-xl p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-center">
                  ...
                  <div className="text-white/80 text-sm font-medium mb-1">Sasaran Siswa</div>
                  <div className="text-white/60 text-xs">Yang belum terlayani</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Data ringkasan sekolah yang belum melaksanakan berdasarkan jenjang pendidikan
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
              Detail Sekolah yang Belum Melaksanakan
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Daftar lengkap sekolah dengan informasi detail yang belum melaksanakan program
            </p>
          </div>
          ...
          <div className="mb-8 max-w-2xl mx-auto">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 rounded-2xl opacity-0 group-focus-within:opacity-20 blur-xl transition-opacity duration-500"></div>
              
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center shadow-lg group-focus-within:scale-110 transition-transform duration-300">
                ...
                <input
                  ...
                  className="w-full pl-16 pr-12 py-4 text-base border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:outline-none transition-all duration-300 shadow-lg hover:shadow-xl focus:shadow-xl bg-white font-medium placeholder:text-gray-400"
                />
                {searchQuery && (
                  <button
            ...
            {searchQuery && (
              <div className="mt-3 px-4 py-2 bg-orange-50 border border-orange-200 rounded-lg text-sm text-orange-700 font-medium flex items-center gap-2">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentSchoolData.map((school) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-orange-600 font-medium">
                        {school.sasaranSiswa.toLocaleString()}
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            {totalPages > 1 && (
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-gray-50 to-white p-4 rounded-xl border border-gray-200 px-6 pb-6">
                <div className="text-sm text-gray-700 font-medium">
                  ...
                  <span className="font-bold text-orange-600">{filteredSchools.length}</span> data
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:border-orange-400"
                  >
                    ««
                  </button>
                  <button
                  ...
                  <div className="px-4 py-2 text-sm font-bold text-white bg-gradient-to-r from-orange-500 to-orange-600 border border-orange-600 rounded-lg shadow-lg">
                    {currentPage}
                  </div>
      ...
      {/* Peta Sebaran - Only show if there are valid locations */}
      {schoolDetails.filter(school => school.latitude !== 0 && school.longitude !== 0).length > 0 && (
        <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-gray-50 via-orange-50/30 to-red-50/20 relative overflow-hidden">
          {/* Decorative elements */}
          <div className="absolute top-0 left-0 w-96 h-96 bg-orange-100/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-red-100/20 rounded-full blur-3xl"></div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Distribusi lokasi sekolah yang belum melaksanakan program
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {schoolDetails
                ...
                .map((school) => (
                  <div
                    key={school.id}
                    className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-200 hover:border-orange-300"
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xs text-orange-600 font-medium">
                        {school.sasaranSiswa.toLocaleString()} siswa
                      </span>
                    </div>
                  </div>
                ))}
