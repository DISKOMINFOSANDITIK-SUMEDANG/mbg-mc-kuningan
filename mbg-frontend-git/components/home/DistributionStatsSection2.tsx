...
import { getStatistics, Statistics, getSPPGDistributionsForTab } from "@/lib/api-client";
  ...
  useEffect(() => {
    const fetchStatistics = async () => {
      try {
        ...
        const [stats, reported, notReported] = await Promise.all([
          getStatistics(),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="bg-gradient-to-r from-amber-50 via-orange-50 to-yellow-50 border-2 border-orange-200 rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 shadow-lg">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="text-left sm:text-right w-full sm:w-auto sm:flex-shrink-0">
                  <div className="text-lg sm:text-xl lg:text-2xl text-orange-600 font-semibold mb-1">81.30%</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 mt-4 sm:mt-5">
            ...
            <div className="group relative bg-gradient-to-br from-emerald-500 via-emerald-600 to-green-600 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-7 lg:p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg mb-4 sm:mb-6">
                  <svg className="w-6 h-6 sm:w-7 sm:h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" />
                  </svg>
                </div>
                <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-2">14</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 mb-3 sm:mb-4">
                  <div className="text-white/80 text-xs font-medium mb-1">Progress</div>
                  <div className="flex items-baseline gap-1.5 sm:gap-2 flex-wrap">
                    <span className="text-xl sm:text-2xl font-bold text-white">14</span>
                    <span className="text-white/70 text-xs sm:text-sm">dari</span>
                    <span className="text-lg sm:text-xl font-bold text-white">309</span>
                    <span className="text-white/70 text-xs">pesantren</span>
                  </div>
                </div>
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/20">
                  <div className="text-2xl sm:text-2xl font-extrabold text-white mb-1">681/10,337</div>
            ...
            <div className="group relative bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-7 lg:p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-2">1,732</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 mb-3 sm:mb-4">
                  <div className="text-white/80 text-xs font-medium mb-1">Progress</div>
                  <div className="flex items-baseline gap-1.5 sm:gap-2 flex-wrap">
                    <span className="text-xl sm:text-2xl font-bold text-white">1,732</span>
                    <span className="text-white/70 text-xs sm:text-sm">dari</span>
                    <span className="text-lg sm:text-xl font-bold text-white">2,707</span>
                    <span className="text-white/70 text-xs">sekolah</span>
                  </div>
                </div>
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/20">
                  <div className="text-2xl sm:text-2xl font-extrabold text-white mb-1">228,266/275,543</div>
            ...
            <div className="group relative bg-gradient-to-br from-pink-500 via-pink-600 to-rose-600 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-7 lg:p-8 transition-all duration-500 hover:shadow-2xl hover:-translate-y-1 overflow-hidden sm:col-span-2 lg:col-span-1">
              ...
              <div className="relative z-10">
                ...
                <div className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-2">49,892</div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 mb-3 sm:mb-4">
                  <div className="text-white/80 text-xs font-medium mb-1">Progress</div>
                  <div className="flex items-baseline gap-1.5 sm:gap-2 flex-wrap">
                    <span className="text-xl sm:text-2xl font-bold text-white">49,892</span>
                    <span className="text-white/70 text-xs sm:text-sm">dari</span>
                    <span className="text-lg sm:text-xl font-bold text-white">86,878</span>
                ...
                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/20 grid grid-cols-3 gap-3 sm:gap-4 text-center">
                  <div>
                    ...
                    <div className="text-xs sm:text-sm font-bold text-white">2,751/8,935</div>
                  </div>
                  <div>
                    <div className="text-white/80 text-xs font-medium mb-1">Busui</div>
                    <div className="text-xs sm:text-sm font-bold text-white">7.525/8,728</div>
                  </div>
                  <div>
                    <div className="text-white/80 text-xs font-medium mb-1">Balita</div>
                    <div className="text-xs sm:text-sm font-bold text-white">39.616/62,700</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  {/* <div className="text-5xl font-extrabold text-white tracking-tight">{statistics.totalSchools?.toLocaleString() || '0'}</div> */}
                  <div className="text-5xl font-extrabold text-white tracking-tight">2707</div>
                  <div className="text-white/80 text-sm font-medium">sekolah terdaftar</div>
                </div>
              </div>
              ...
              {/* Total Students Display - Compact */}
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 mb-3">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-white/80 text-xs font-medium mb-1">Total Siswa Terdaftar</div>
                    <div className="text-3xl font-extrabold text-white tracking-tight">
                      {/* {statistics.totalStudents?.toLocaleString() || '0'} */}
                      275,543
                    </div>
                    <div className="text-white/70 text-xs font-medium mt-1">
                      {/* dari {statistics.totalSchools?.toLocaleString() || '0'} sekolah */}
                      dari 2707 sekolah
                    </div>
                  </div>
                  <div>
                    <div className="text-white/80 text-xs font-medium mb-1">Rata-rata Siswa/SPPG</div>
                    <div className="text-3xl font-extrabold text-white tracking-tight">
                      {statistics.totalStudents && statistics.totalSppgs ? 
                        Math.round((statistics.totalStudents || 0) / statistics.totalSppgs).toLocaleString() : '0'}
                    </div>
                    <div className="text-white/70 text-xs font-medium mt-1">
                      per {statistics.totalSppgs} SPPG aktif
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 mb-3">
                <div className="text-center">
                  <div className="text-2xl font-extrabold text-white mb-1">{statistics.totalSppgs}</div>
                  <div className="text-white/70 text-xs font-medium">Total SPPG Melayani Seluruh Sekolah</div>
                </div>
              </div> */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-between items-center">
                <div className="text-white">
                  <div className="text-3xl font-extrabold tracking-tight">{statistics.todayDistribution.totalDistributionPortions.toLocaleString()}</div>
                  <div className="text-sm text-white/80 font-medium">Total Porsi Distribusi</div>
                </div>
                <div className="text-right">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  ...
                  <div className="text-white/80 text-sm font-medium">dari 1,732 sekolah <br /> penerima manfaat </div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                <div className="text-white">
                  <div className="text-3xl font-extrabold tracking-tight">{statistics.todayDistribution.totalMBGReports.toLocaleString()}</div>
                  <div className="text-sm text-white/80 font-medium">Total Laporan MBG</div>
                </div>
                <div className="text-right">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
          ...
          <div className="group bg-white rounded-2xl p-6 text-center shadow-md hover:shadow-xl transition-all duration-300 border border-green-100/50 hover:-translate-y-1">
            ...
            <div className="text-sm font-semibold text-gray-600">Laporan SPPG Hari Ini</div>
          </div>
          ...
          {/* Laporan Sekolah Hari Ini */}
          <div className="group bg-white rounded-2xl p-6 text-center shadow-md hover:shadow-xl transition-all duration-300 border border-purple-100/50 hover:-translate-y-1">
            ...
            <div className="text-4xl font-extrabold bg-gradient-to-br from-purple-600 to-purple-700 bg-clip-text text-transparent mb-2">
              {statistics.todayDistribution.schoolsReportedToday}
            </div>
            <div className="text-sm font-semibold text-gray-600">Laporan Sekolah Hari Ini</div>
            <div className="mt-2 text-xs text-gray-500 font-medium">
              {/* {statistics.todayDistribution.schoolReportPercentage}% dari {statistics.totalSchools || 0} sekolah */}
              {statistics.todayDistribution.schoolReportPercentage}% dari 1,732 sekolah
            </div>
          </div>
        </div>
