...
import { DailyMenu } from '@/lib/api-client';
...
export default function MenuDetail({ dailyMenu }: MenuDetailProps) {
  ...
  const getNutritionColor = (value: number, type: 'calories' | 'protein' | 'carbs' | 'fat') => {
    ...
    if (value < thresholds[type].low) return 'text-red-700';
    if (value > thresholds[type].high) return 'text-green-700';
      ...
      <div className="bg-green-600 px-6 py-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-green-50">Menu Makanan Sehat</p>
          </div>
        </div>
        
        {dailyMenu.notes && (
          <div className="bg-white/20 rounded-lg p-3">
            <p className="text-green-50 text-sm">{dailyMenu.notes}</p>
          </div>
        )}
      </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Kalori</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Karbohidrat</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Lemak</p>
            </div>
          </div>
        </div>
              ...
              <div key={item.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-700">kal</p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-700">karbohidrat</p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-700">lemak</p>
                  </div>
                </div>
                ...
                {item.allergens.length > 0 && (
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">Mengandung: </span>
